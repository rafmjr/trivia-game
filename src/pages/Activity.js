...
function Activity() {
    ...
    async function handleSubmit(e) {
        ...
        if (!_id) {
            ...
            window.location.href = `/dashboard/activities/${data.activity._id}`;
            return;
        }
        ...
        <CCard>
            <CForm className="form-horizontal" onSubmit={handleSubmit}>
                ...
                <CCardBody>
                    ...
                    <CFormGroup row>
                        <CCol md="3">
                            <CLabel htmlFor="solution">Answer</CLabel>
                        </CCol>
                        <CCol xs="12" md="9">
                            <CInput
                                id="solution"
                    ...
                    {!isOpenQuestion &&
                        answers.map((option, index) => (
                            <CFormGroup row key={option + index}>
                                <CCol md="3">{index === 0 && <CLabel htmlFor="email-input">Options</CLabel>}</CCol>
                                <CCol xs="12" md="9">
                                    <CInputGroup>
                                        <CInput
                                            defaultValue={option}
                    ...
                    {!isOpenQuestion && (
                        <CFormGroup row>
                            <CCol md="3">{answers.length === 0 ? 'Options' : ''}</CCol>
                            <CCol xs="12" md="9">
                                <CInput
                                    onBlur={(e) => {
                                        const newAnswers = answers.slice();
